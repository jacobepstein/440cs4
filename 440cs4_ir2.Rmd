...
ATT_mix = mean(unlist(olp.debit[ATT_matching_1$index.treated, "spending1998"])) - sum(olp.debit[ATT_matching_1$index.control, "spending1998"] + mu2 - mu1, na.rm = TRUE)/(6*treat_size1)
