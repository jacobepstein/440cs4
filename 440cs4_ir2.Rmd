...
reg_adj_results=data.frame(
  ...
  "type"=c("Unmatched Linear","Unmatched Linear",
...
ggplot(reg_adj_results,aes(names,vals,fill=type))+
  geom_col()+
  labs(title="ATT and ATE for all Models Explored",x="Metric",y="Value")+
  coord_flip()
```
