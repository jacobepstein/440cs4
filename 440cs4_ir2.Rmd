...
#ATE DR
ATE_DR <-mean(olp.debit$debit_card1998*olp.debit$spending1998/olp.debit$ps_basicLog)-mean((olp.debit$debit_card1998-olp.debit$ps_basicLog)*predict(b_treated,newdata=olp.debit,type="response")/olp.debit$ps_basicLog)-mean((1-olp.debit$debit_card1998)*olp.debit$spending1998/(1-olp.debit$ps_basicLog))-mean((olp.debit$debit_card1998-olp.debit$ps_basicLog)*predict(b_control,newdata=olp.debit,type="response")/(1-olp.debit$ps_basicLog))
```
...
xtable(rbind(c(ATE_1,ATE_mix,ATE_ipw_bl,ATE_DR),
