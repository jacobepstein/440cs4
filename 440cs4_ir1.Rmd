...
treat = unique(ATT_match_norep$index.treated)
control = unique(ATT_match_norep$index.control)
...
boxplot(ori_asd, match_asd, weight_asd, main="ASD for Different Methods",names=c("original","matching","weighting"),ylab="Abs Standardized Difference")
```
