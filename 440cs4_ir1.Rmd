...
first_model = glm(prop_score_model(), family = binomial(link="logit"), data = debit)
...
model_control_m<-lm(outcome_formula(), data = controls)
model_treated_m<-lm(outcome_formula(), data = treats)
